...
class Attention(nn.Module):
    def __init__(self, hidden_size):
        ...
        self.attention_network = nn.Sequential(nn.Linear(hidden_size*2, hidden_size),
    ...
    def forward(self, hidden, annotations):
        ...
        unnormalized_attention = attention_net_output.expand_as(torch.zeros(batch_size, seq_len, 1))  # Reshape attention net output to have dimension batch_size x seq_len x 1
